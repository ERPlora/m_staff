...
SOPS = [
    ...
    {
        "id": "add_staff",
        "triggers_es": ["nuevo empleado", "anadir personal", "dar de alta empleado"],
        "triggers_en": ["new employee", "add staff member", "hire employee"],
        "steps": ["list_roles", "create_staff_member"],
        "modules_required": ["staff"],
    },
    {
        "id": "deactivate_staff",
        "triggers_es": ["desactivar empleado", "dar de baja"],
        "triggers_en": ["deactivate employee", "deactivate staff"],
        "steps": ["list_staff", "deactivate_staff_member"],
        "modules_required": ["staff"],
    },
    {
        "id": "manage_roles",
        "triggers_es": ["ver roles", "crear rol", "gestionar roles"],
        "triggers_en": ["list roles", "create role", "manage roles"],
        "steps": ["list_roles", "create_role"],
        "modules_required": ["staff"],
    },
]
